...
namespace SevenUpdate
{
    ...
    internal static class NativeMethods
    {
        ...
        ///    name="componentPath" /> parameter. On input, this is the full size of the buffer, including a space for a
        ///    terminating <c>null</c> character. If the buffer passed in is too small, the count returned does not
        ///    include the terminating <c>null</c> character.
        /// </param>
        /// <returns>
        ...
        ///   The feature name of the shortcut. The string buffer must be MAX_FEATURE_CHARS+1 characters long. This
        ///   parameter can be <c>null</c>.
        /// </param>
        /// <param name="componentCode">
        ///   A GUID of the component code. This string buffer must be 39 characters long. The first 38 characters are
        ///   for the GUID, and the last character is for the terminating <c>null</c> character. This parameter can be
        ///   <c>null</c>.
        /// </param>
        /// <returns>
        ///   The return code.
