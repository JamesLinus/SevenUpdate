...
namespace SevenUpdate
{
    ...
    internal static class NativeMethods
    {
        ...
        /// the buffer pointed to by the <paramref
        ///    name = "componentPath" /> parameter. On input, this is the full size of the buffer, including a space for
        ///    a terminating <c>null</c> character. If the buffer passed in is too small, the count returned does not
        ///    include the terminating <c>null</c> character.</param>
