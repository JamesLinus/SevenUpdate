    ...
    public static class Base
    {
        ...
        public static string ConvertPath(string path, bool expand, bool is64Bit)
        {
            ...
            if (expand == false)
            {
                ...
                NativeMethods.SHGetSpecialFolderPath(IntPtr.Zero, path2, NativeMethods.CommonPrograms, false);
                stringBuilder = stringBuilder.Replace(path2.ToString(), "%ALLUSERSSTARTMENUPROGRAMS%", true);
                NativeMethods.SHGetSpecialFolderPath(IntPtr.Zero, path2, NativeMethods.CommonStartMenu, false);
        ...
        public static string Replace(this string str, string find, string replace, bool ignoreCase)
        {
            ...
            {
                if (0 == string.Compare(str, pos, find, 0, findLength, ignoreCase))
                {
