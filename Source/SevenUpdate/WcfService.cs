// <copyright file="WcfService.cs" project="SevenUpdate">Robert Baker</copyright>
...
namespace SevenUpdate
{
    ...
    internal class WcfService : IElevatedProcessCallback
    {
        ...
        {
            bool abort = Utilities.StartProcess(Path.Combine(Utilities.AppDir, @"SevenUpdate.Admin.exe"), "Abort");
        ...
        internal static void AdminError(Exception e)
        {
            ...
            Process[] processes = Process.GetProcessesByName("SevenUpdate.Admin");
