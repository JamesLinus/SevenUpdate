...
namespace SevenUpdate.Sdk
{
    ...
    internal static class Core
    {
        ...
        /// <param name="initialDirectory">Gets or sets the initial directory displayed when the dialog is shown. A <c>null</c> or empty string indicates that the dialog is using the default directory.</param>
