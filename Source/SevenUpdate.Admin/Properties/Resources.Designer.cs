...
namespace SevenUpdate.Admin.Properties
{
    ...
    public class Resources {
        ...
        /// <summary>Looks up a localized string similar to Downloading updates... ({0} out of {1} files complete).</summary>
        ...
        /// <summary>Looks up a localized string similar to Seven Update has completed the installation of updates.</summary>
        ...
        /// <summary>Looks up a localized string similar to Installing updates {0}% complete....</summary>
        ...
        /// <summary>Looks up a localized string similar to Updates have been downloaded.</summary>
        ...
        /// <summary>Looks up a localized string similar to Updates have been downloaded, click here to view them.</summary>
        ...
        /// <summary>Looks up a localized string similar to Communication with the update service has been interrupted and cannot be resumed.</summary>
        public static string UpdateServiceInterrupted {
            get {
                return ResourceManager.GetString("UpdateServiceInterrupted", resourceCulture);
            }
        }
        
        /// <summary>Looks up a localized string similar to Updates have been found.</summary>
        ...
        /// <summary>Looks up a localized string similar to Updates have been found, click here to view them.</summary>
        ...
        /// <summary>Looks up a localized string similar to Updates have been installed.</summary>
