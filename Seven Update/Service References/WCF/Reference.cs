...
{
    [GeneratedCode("System.ServiceModel", "4.0.0.0"), ServiceContract(ConfigurationName = "WCF.IEventSystem", CallbackContract = typeof (IEventSystemCallback), SessionMode = SessionMode.Required)]
    ...
    public class EventSystemClient : DuplexClientBase<IEventSystem>, IEventSystem
    {
        ...
        public EventSystemClient(InstanceContext callbackInstance, string endpointConfigurationName, string remoteAddress) : base(callbackInstance, endpointConfigurationName, remoteAddress)
        {
        }

        public EventSystemClient(InstanceContext callbackInstance, string endpointConfigurationName, EndpointAddress remoteAddress) : base(callbackInstance, endpointConfigurationName, remoteAddress)
        {
        }
