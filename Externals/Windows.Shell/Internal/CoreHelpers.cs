...
namespace Microsoft.Windows.Internal
{
    ...
    public static class CoreHelpers
    {
        ...
        /// <summary>
        ///   Gets a value indicating whether the application is running on Vista
        /// </summary>
        ...
        /// <summary>
        ///   Gets a value indicating whether the application is running on Windows 7
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// The string resource corresponding to the given resource Id. Returns <see langword="null"/> if the resource id
        ...
        /// <summary>
        /// Throws <see cref="PlatformNotSupportedException"/> if the application is not running on Windows Vista
        /// </summary>
        ...
        /// <summary>
        /// Throws <see cref="PlatformNotSupportedException"/> if the application is not running on Windows 7
        /// </summary>
        ...
        /// <summary>
        /// Throws <see cref="PlatformNotSupportedException"/> if the application is not running on Windows XP
        /// </summary>
