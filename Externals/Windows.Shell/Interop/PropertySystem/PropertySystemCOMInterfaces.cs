...
#pragma warning disable 108
    ...
    internal interface IPropertyDescription
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetRelativeDescription([In] ref PropVariant propvar1, [In] ref PropVariant propvar2, [MarshalAs(UnmanagedType.LPWStr)] out string ppszDesc1,
    ...
    internal interface IPropertyEnumTypeList
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetAt([In] uint itype, [In] ref Guid riid, // riid may be IID_IPropertyEnumType
