...
namespace Microsoft.Windows.Shell.PropertySystem
{
    ...
    public partial class ShellProperties
    {
        ...
        /// </summary>
        public PropertySystem System { get { return propertySystem ?? (propertySystem = new PropertySystem(ParentShellObject)); } }

        /// <summary>
        ///   Gets the collection of all the default properties for this item.
        /// </summary>
        public ShellPropertyCollection DefaultPropertyCollection { get { return defaultPropertyCollection ?? (defaultPropertyCollection = new ShellPropertyCollection(ParentShellObject)); } }
