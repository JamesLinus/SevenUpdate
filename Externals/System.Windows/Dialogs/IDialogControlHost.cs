...
{
    /// <summary>Indicates that the implementing class is a dialog that can host
    /// customizable dialog controls (subclasses of <see cref="DialogControl"/>).</summary>
    public interface IDialogControlHost
    {
        ...
        /// has a property changed.</summary>
