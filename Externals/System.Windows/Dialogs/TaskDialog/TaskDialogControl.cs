...
namespace System.Windows.Dialogs
{
    ...
    public abstract class TaskDialogControl : DialogControl
    {
        ...
        /// <summary>Initializes a new instance of the TaskDialogControl class.</summary>
        protected TaskDialogControl()
        {
        }

        /// <summary>Initializes a new instance of the <c>TaskDialogControl</c> class.</summary>
