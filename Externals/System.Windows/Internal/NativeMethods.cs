...
namespace System.Windows.Internal
{
    ...
    public static class NativeMethods
    {
        ...
        /// <summary>Sends the specified message to a window or windows. The SendMessage function calls the window procedure for the specified window and does not return until the windowprocedure has processed the message.</summary>
