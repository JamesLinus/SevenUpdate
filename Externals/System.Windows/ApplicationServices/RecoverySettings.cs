...
namespace System.Windows.ApplicationServices
{
    ...
    /// </summary>
    /// <remarks>
    ///   This class is used to register for application recovery.See the <see cref="ApplicationRestartRecoveryManager" /> class.
    /// </remarks>
    public class RecoverySettings
    {
        ...
        /// </summary>
        /// <param name="data">
        ///   A recovery data object that contains the callback method (invoked by the system before Windows Error Reporting terminates the application) and an optional state object.
        /// </param>
        /// <param name="interval">
        ///   The time interval within which the callback method must invoke <see
        ///    cref="ApplicationRestartRecoveryManager.ApplicationRecoveryInProgress" /> to prevent WER from terminating the application.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        ///   The recovery ping interval is specified in milliseconds. By default, the interval is 5 seconds. If you specify zero, the default interval is used.
        /// </remarks>
        public uint PingInterval { get; private set; }

        /// <summary>
        ///   Gets the recovery data object that contains the callback method and an optional parameter (usually the state of the application) to be passed to the callback method.
        /// </summary>
