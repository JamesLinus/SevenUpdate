    ...
    public static class LocalizedObjectOperation
    {
        ...
        public static string GetErrorMessage(int errorNo)
        {
            try
            {
                return
                    (string)
                    LocalizeDictionary.Instance.GetLocalizedObject<object>(LocalizeDictionary.Instance.GetAssemblyName(Assembly.GetExecutingAssembly()), "ResError", "ERR_" + errorNo,
        ...
        public static string GetHelpString(string key)
        {
            ...
            try
            {
                return
                    (string)
                    LocalizeDictionary.Instance.GetLocalizedObject<object>(LocalizeDictionary.Instance.GetAssemblyName(Assembly.GetExecutingAssembly()), "ResHelp", key,
                                                                           LocalizeDictionary.Instance.Culture);
            }
            catch
            {
        ...
        public static string GetMaintenanceString(string key)
        {
            ...
            try
            {
                return
                    (string)
                    LocalizeDictionary.Instance.GetLocalizedObject<object>(LocalizeDictionary.Instance.GetAssemblyName(Assembly.GetExecutingAssembly()), "ResMaintenance", key,
                                                                           LocalizeDictionary.Instance.Culture);
            }
            catch
            {
        ...
        public static string GetUpdateAgentString(string key)
        {
            ...
            try
            {
                return
                    (string)
                    LocalizeDictionary.Instance.GetLocalizedObject<object>(LocalizeDictionary.Instance.GetAssemblyName(Assembly.GetExecutingAssembly()), "ResUpdateAgent", key,
                                                                           LocalizeDictionary.Instance.Culture);
            }
            catch
            {
