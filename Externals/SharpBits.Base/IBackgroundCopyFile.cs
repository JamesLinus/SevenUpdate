...
namespace SharpBits.Base
{
    ...
    /// <summary>
    ///   The IBackgroundCopyFile interface contains information about a file that is part of a job. For example,
    ///   you can use the interfaces methods to retrieve the local and remote names of the file and transfer
