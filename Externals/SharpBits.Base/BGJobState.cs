// ***********************************************************************
// <copyright file="BGJobState.cs" project="SharpBits.Base" assembly="SharpBits.Base" solution="SevenUpdate" company="Xidar Solutions">
...
namespace SharpBits.Base
{
    ...
    internal enum BGJobState
    {
        ...
        /// <summary>
        ///   Specifies that a non-recoverable error occurred (the service is  unable to transfer the file). When the
        ///   error can be corrected,  such as an access-denied error, call the IBackgroundCopyJob::Resume  method after
        ///   the error is fixed. However, if the error cannot be  corrected, call the IBackgroundCopyJob::Cancel method
        ///   to cancel  the job, or call the IBackgroundCopyJob::Complete method to accept  the portion of a download
        ///   job that transferred successfully.
        /// </summary>
        Error = 4,
