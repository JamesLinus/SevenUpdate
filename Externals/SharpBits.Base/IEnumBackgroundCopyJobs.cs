...
namespace SharpBits.Base
{
    ...
    internal interface IEnumBackgroundCopyJobs
    {
        ...
        /// <paramref
        ///    name = "copyJob" /> when done.</param>
        /// <param name = "celtFetched">Number of elements returned in <paramref name = "copyJob" />. You can set
        /// fetched to <c>null</c> if <paramref
        ///    name = "copyJob" /> is one. Otherwise, initialize the value of fetched to 0 before calling this
        ///    method.</param>
