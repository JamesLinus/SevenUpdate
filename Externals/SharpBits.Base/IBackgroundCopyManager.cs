...
namespace SharpBits.Base
{
    ...
    internal interface IBackgroundCopyManager
    {
        ...
        ///   The name is limited to 256 characters, not including the <c>null</c> terminator.
        /// </param>
        /// <param name="type">
        ///   Type of transfer job, such as BGJob_TYPE_DOWNLOAD. For a list of transfer types, see the BGJob_TYPE
        ///   enumeration.
        /// </param>
        /// <param name="jobId">
        ///   Uniquely identifies your job in the queue. Use this identifier when you call the
        ///   <c>IBackgroundCopyManager</c>::<c>GetJob</c> method to get a job from the queue.
        /// </param>
        /// <param name="job">
        ///   An <c>IBackgroundCopyJob</c> interface pointer that you use to modify the job's properties and specify the
        ///   files to be transferred. To activate the job in the queue, call the <see
        ...
        /// </param>
        /// <param name="enum">
        ///   An <c>IEnumBackgroundCopyJobs</c> interface pointer that you use to enumerate the jobs in the transfer
        ///   queue. The contents of the enumerator depend on the value of <paramref
