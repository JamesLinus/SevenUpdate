...
namespace SharpBits.Base
{
    ...
    internal interface IBackgroundCopyManager
    {
        ...
        /// <param name = "enum">An <c>IEnumBackgroundCopyJobs</c> interface pointer that you use to enumerate the jobs
        /// in the transfer queue. The contents of the enumerator depend on the value of <paramref
        ///    name = "flags" />. Release p@enumJobs when done.</param>
