// <copyright file="IBackgroundCopyJob.cs" project="SharpBits.Base">Xidar</copyright>
...
namespace SharpBits.Base
{
    ...
    /// <summary>
    ///   Use the IBackgroundCopyJob interface to add files to the job, set the priority level of the job, determine the
    ///   state of the job, and to start and stop the job.
    /// </summary>
    ...
    internal interface IBackgroundCopyJob
    {
        ...
        /// <param name="val">Contains job-related time stamps. For available time stamps, see the <c>BGJobTimes</c> structure.</param>
        ...
        /// default is <see cref="BGJobPriority" />.Normal. For a list of priority levels, see the <c>BGJobPriority</c>
        /// enumeration.</param>
        ...
        /// <summary>
        ///   Specifies a pointer to your implementation of the<c>IBackgroundCopyCallback</c> interface (callbacks). The
        ///   interface receives notification based on the event notification flags you set.
        /// </summary>
        ...
        /// <param name="val">Interface pointer to your implementation of the <c>IBackgroundCopyCallback</c> interface. When done, release notifyInterface.</param>
        ...
        /// the <c>null</c> terminator.</param> <param name="proxyBypassList">A string that contains an optional list of
        /// host names, IP addresses, or both, that can bypass the proxy. The list is space-delimited. For details on
        ...
        /// proxy options, see the <see cref="BGJobProxyUsage" /> enumeration.</param> <param name="proxyList">A string
        /// that contains one or more proxies to use to transfer files. The list is space-delimited. For details on the
        /// format of the string, see the Listing Proxy Servers section of Enabling Internet Functionality. Call the
        /// CoTaskMemFree function to free <paramref name="proxyList" /> when done.</param> <param
