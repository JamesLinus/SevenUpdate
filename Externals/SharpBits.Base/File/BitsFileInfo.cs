namespace SharpBits.Base.File
{
    public class BitsFileInfo
    {
        ...
        public string RemoteName { get { return fileInfo.RemoteName; } }

        public string LocalName { get { return fileInfo.LocalName; } }

        internal BG_FILE_INFO _BG_FILE_INFO { get { return fileInfo; } }
    }
}