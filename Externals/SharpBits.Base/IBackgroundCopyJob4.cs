...
namespace SharpBits.Base
{
    ...
    internal interface IBackgroundCopyJob4
    {
        ...
        /// <param name="remoteUrl">A string that contains the name of the file on the client. For information on specifying the local name, see the LocalName member and Remarks section of the <see cref="BGFileInfo" /> structure.</param>
        ...
        /// <param name="val">A string that identifies the job. Must not be <see langword="null" />. The length of the string is limited to 256 characters, not including the <see langword="null" /> terminator. .</param>
        ...
        /// <param name="val">A string that provides additional information about the job. The length of the string is limited to 1,024 characters, not including the <see langword="null" /> terminator.</param>
        ...
        /// <param name="replyFileName">A string that contains the full path to the reply file. Call the CoTaskMemFree function to free <paramref name="replyFileName" /> when done. .</param>
