...
namespace SharpBits.Base
{
    ...
    internal static class NativeMethods
    {
        ...
        /// /> buffer. If the function fails because the buffer is too small or if <paramref
        ///    name = "referencedDomainName" /> is zero, <paramref name = "referencedDomainName" /> receives the
        ///    required buffer size, including the terminating <c>null</c> character.</param>
