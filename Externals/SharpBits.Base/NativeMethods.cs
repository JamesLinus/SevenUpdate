...
namespace SharpBits.Base
{
    ...
    internal static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="sid">
        ///   A pointer to a <c>null</c>-terminated string containing the string-format SID to convert. The SID string
        ///   can use either the standard S-R-I-S-S� format for SID strings, or the SID string constant format, such as
        ///   "BA" for built-in administrators.
        /// </param>
        ...
        ///   A pointer to a <c>null</c>-terminated character string that specifies the target computer. This string can
        ///   be the name of a remote computer. If this parameter is <c>null</c>, the account name translation begins on
        ///   the local system. If the name cannot be resolved on the local system, this function will try to resolve
        ...
        /// </param>
        /// <param name="nameSize">
        ///   On input, specifies the size, of the name buffer. If the function fails because the buffer is too small or
        ///   if name is zero, name receives the required buffer size, including the terminating <c>null</c> character.
        /// </param>
        /// <param name="referencedDomainName">
        ///   A pointer to a buffer that receives a <c>null</c>-terminated string that contains the name of the domain
        ///   where the account name was found.
        /// </param>
        /// <param name="domainNameSize">
        ///   On input, specifies the size, of the <paramref name="referencedDomainName" /> buffer. If the function
        ///   fails because the buffer is too small or if <paramref name="referencedDomainName" /> is zero, <paramref
