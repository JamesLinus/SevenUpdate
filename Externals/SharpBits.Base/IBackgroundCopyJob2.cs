...
namespace SharpBits.Base
{
    ...
    /// <summary>
    ///   Use the IBackgroundCopyJob2 interface to retrieve reply data from an upload-reply job, determine the
    ///   progress of the reply data transfer to the client, request command line execution, and provide
    ///   credentials for proxy and remote server authentication requests.
    /// </summary>
    [ComImport]
