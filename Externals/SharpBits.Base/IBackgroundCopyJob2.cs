...
namespace SharpBits.Base
{
    ...
    internal interface IBackgroundCopyJob2
    {
        ...
        /// The default is BGJobPriorityNormal. For a list of priority levels, see the <see
        ///    cref = "BGJobPriority" /> enumeration. .</param>
        ...
        /// BGJobProxyUsagePreConfig. For a list of proxy options, see the <see
        ///    cref = "BGJobProxyUsage" /> enumeration.</param>
        /// <param name = "proxyList">A string that contains the proxies to use to transfer files. The list is
        /// space-delimited. For details on specifying a proxy, see Remarks. This parameter must be <c>null</c> if the
        /// value of <see
        ///    cref = "ProxyUsage" /> is BGJobProxyUsagePreConfig, BGJobProxyUsageNoProxy, or
        ///    BGJobProxyUsageNoAutoDetect. The length of the proxy list is limited to 4,000 characters, not including
        ...
        ///    cref = "BGJobProxyUsage" /> enumeration. .</param>
        /// <param name = "proxyList">A string that contains one or more proxies to use to transfer files. The list is
        /// space-delimited. For details on the format of the string, see the Listing Proxy Servers section of Enabling
        /// Internet Functionality. Call the CoTaskMemFree function to free <paramref
        ///    name = "proxyList" /> when done.</param>
        ...
        /// transfer that is complete. For more information, see <see
        ///    cref = "BGJobReplyProgress" />.</param>
        ...
        /// function to free <paramref
        ///    name = "replyFileName" /> when done. .</param>
        ...
        /// credentials to use for user authentication. For details, see the <see
        ///    cref = "BGAuthCredentials" /> structure. If the job currently contains credentials with the same target
        ///    and scheme pair, the existing credentials are replaced with the new credentials. The credentials persist
        ///    for the life of the job. To remove the credentials from the job, call the IBackgroundCopyJob2::<see
        ///   cref = "RemoveCredentials" /> method. .</param>
        ...
        /// <param name = "scheme">Identifies the authentication scheme to use (basic or one of several
        /// challenge-response schemes). For details, see the <see
        ///    cref = "BGAuthScheme" /> enumeration. .</param>
