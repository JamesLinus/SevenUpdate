// <copyright file="IBackgroundCopyFile2.cs" project="SharpBits.Base">Xidar</copyright>
...
namespace SharpBits.Base
{
    ...
    internal interface IBackgroundCopyFile2
    {
        ...
        /// <param name="remoteName">A string that contains the name of the file on the server.</param>
