// ***********************************************************************
// <copyright file="TaskDialogConfiguration.cs" project="SevenSoftware.Windows" assembly="SevenSoftware.Windows" solution="SevenUpdate" company="Microsoft Corporation">
...
namespace SevenSoftware.Windows.Dialogs.TaskDialog
{
    ...
    internal class TaskDialogConfiguration
    {
        ...
        internal TaskDialogOptions TaskDialogFlags { get; set; }

        /// <summary>Gets or sets the common buttons.</summary>
        internal TaskDialogCommonButtons CommonButtons { get; set; }

        /// <summary>Gets or sets the main icon.</summary>
        internal IconUnion MainIcon { get; set; }
        ...
        /// </summary>
        internal uint ButtonCount { get; set; }
        ...
        /// </summary>
        internal IntPtr RadioButtons { get; set; }
        ...
        /// </summary>
        internal int DefaultRadioButtonIndex { get; set; }

        /// <summary>Gets or sets the footer icon</summary>
        internal IconUnion FooterIcon { get; set; }

        /// <summary>Gets or sets the application-defined callback function.</summary>
        internal NativeMethods.TaskDialogCallback Callback { get; set; }
