...
namespace SevenUpdate
{
    ...
    public struct SUA
    {
        ...
        public Collection<LocaleString> ApplicationName { get; set; }
                
        /// <summary>
        /// Gets release information about the update
        /// </summary>
        [XmlElementAttribute("Description")]
        public Collection<LocaleString> Description { get; set; }
        ...
        public Collection<LocaleString> Publisher { get; set; }
    ...
    {
        /// <summary>
        /// Gets the application main directory, usually in Program Files
        /// </summary>
        [XmlAttribute("Directory")]
        public string Directory { get; set; }

        /// <summary>
        /// Gets the help url of the update: Optional
        /// </summary>
        [XmlAttribute("HelpUrl")]
        public string HelpUrl { get; set; }
        
        /// <summary>
        /// Gets the application name in which the update applies too
        /// </summary>
        [XmlElementAttribute("Name")]
        public Collection<LocaleString> Name { get; set; }
        ...
        /// <summary>
        /// Gets the applications application
        /// </summary>
    ...
    {             
        ...
        public Collection<UpdateFile> Files { get; set; }   
                
        /// <summary>
        /// Gets the update type of the update: Important, Recommended, Optional, Locale, Installation.
        /// </summary>
        [XmlAttribute("Importance")]
        public Importance Importance { get; set; }

        /// <summary>
        /// Gets the information/changelog url of the update: Optional
        /// </summary>
        [XmlAttribute("InfoUrl")]
        public string InfoUrl { get; set; }
        
        /// <summary>
        /// Gets the Software License Agreement Url
        /// </summary>
        ...
        public Collection<RegistryItem> RegistryItems { get; set; }

        /// <summary>
        /// Gets the date when the update was released
        /// </summary>
        ...
        public Collection<Shortcut> Shortcuts { get; set; }

        /// <summary>
        /// Gets the title or name of the update
        /// </summary>
        [XmlElementAttribute("Title")]
        public Collection<LocaleString> Title { get; set; }
    }
    ...
    public struct UpdateInformation
    {
        ...
        /// <summary>
        /// Gets the update type of the update: Critical, Recommended, Optional, Locale
        /// </summary>
        [XmlAttribute("Importance")]
        public Importance Importance { get; set; }
        ...
        /// <summary>
        /// Gets the date when the update was installed
        /// </summary>
        ...
        public Collection<LocaleString> UpdateTitle { get; set; }
    }
    #endregion
    ...
    public class Shared
    {
        ...
        public static Collection<T> DeserializeCollection<T>(string xmlFile) where T : struct
        {
            if (File.Exists(xmlFile))
            {
                XmlSerializer s = new XmlSerializer(typeof(Collection<T>));
                ...
                using (TextReader r = new StreamReader(xmlFile))
                {
                    try
                    {
                        temp = (Collection<T>)s.Deserialize(r);
        ...
        public static T Deserialize<T>(string xmlFile) where T : struct
        {
            if (File.Exists(xmlFile))
            {
        ...
        public static void SerializeCollection<T>(Collection<T> list, string xmlFile) where T : struct
        {
            try
            {
                XmlSerializer s = new XmlSerializer(typeof(Collection<T>));
        ...
        /// <param name="xmlFile">The location of a file that will be serialized</param>
        public static void Serialize<T>(T item, string xmlFile) where T : struct
        {
            try
            {
                XmlSerializer s = new XmlSerializer(typeof(T));
