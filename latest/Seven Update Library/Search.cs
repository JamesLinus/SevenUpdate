...
namespace SevenUpdate
{
    ...
    public static class Search
    {
        ...
        static bool CheckForUpdates(string suiFile, Collection<UpdateInformation> hidden)
        {
        ...
        {
            public SearchDoneEventArgs(Collection<Application> applications)
            {
                Applications = applications;
            }

            /// <summary>
            /// Collection of the updates found
            /// </summary>
