...
namespace SevenUpdate.WCF
{
    class Client : ESB.IEventSystemCallback
    {
        ...
        {
            Shared.SerializeCollection<Application>(Program.Applications, Shared.appStore + "Update List.xml");
        ...
        /// <returns>Returns true if sucessful</returns>
        internal static bool HideUpdates(Collection<UpdateInformation> hiddenUpdates)
        {
        ...
        internal static bool SaveSettings(bool AutoOn, UpdateOptions options, Collection<SUA> sul)
        {
